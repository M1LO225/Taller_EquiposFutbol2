...
namespace Taller_EquiposFutbol2.Controllers
{
    public class EstadioController : Controller
    {
        private readonly Taller_EquiposFutbol2Context _context;

        public EstadioController(Taller_EquiposFutbol2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstadio,NombreEstadio,Direccion,Ciudad,Capacidad")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstadio,NombreEstadio,Direccion,Ciudad,Capacidad")] Estadio estadio)
        {
